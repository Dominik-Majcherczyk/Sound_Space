...
export default function Auth() {
  ...
  return (
    <div>
      ...
      <div class="mt-8 mx-auto flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
        ...
        <div class="mt-8">
          <form onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="flex items-center mb-6 {isSignup ? -mt-0 : -mt-4}">
        ...
        <div className="flex items-center justify-center mt-6">
          <a
            ...
            target="_blank"
            className="cursor-pointer inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white"
          >
            <span className="ml-2">
              {isSignup
                ? `Already have an account? Sign In`
